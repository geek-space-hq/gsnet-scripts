#!/bin/sh
# base: https://gist.github.com/miminashi/e0328a8c246a99c616ef5cae99d095b4
#
# 使い方:
#   curl -L https://raw.githubusercontent.com/geek-space-hq/gsnet-scripts/master/gateway-setup/nat/setup_gsngw01.sh > /tmp/setup_tinc.sh; sudo sh /tmp/setup_tinc.sh <ノード名> <IPアドレス>
#
